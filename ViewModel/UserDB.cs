...
namespace ViewModel
{
    ...
    public class UserDB : BaseDB
    {
        ...
        public UserList SelectbySnacks(Snacks snack)
        {
            command.CommandText = $"SELECT * FROM (Tbsnacks INNER JOIN Idsnacks ON TblUsers.ID = Idsnacks.IDsancks) WHERE IDuser={snack.Id}";
            UserList list = new UserList(base.ExecuteCommand());
            return list;
        }
    }
